...
class UsineImplTest {
    ...
    void produitUneLunetteUnique() {
        try (Usine usine = new UsineImpl(new FakeFabricateur(5))) {
    ...
    void commandeDepassantLaCapaciteEstDecoupeeEnBatchs() {
        ...
        try (Usine usine = new UsineImpl(new FakeFabricateur(3))) {
    ...
    void produitCommandeAvecBatchFinalPartiel() {
        ...
        try (Usine usine = new UsineImpl(new FakeFabricateur(4))) {
